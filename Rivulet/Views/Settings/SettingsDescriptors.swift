...
enum SettingsDescriptorStore {
    ...
    private static let descriptors: [String: SettingDescriptor] = [
        ...
        "autoSkipIntroSettings": SettingDescriptor(
            icon: "play.circle",
            iconColor: .green,
            description: "Choose which intro marker sources can automatically skip TV show intros."
        ),
        "autoSkipIntroPlex": SettingDescriptor(
            icon: "play.circle",
            iconColor: .green,
            description: "Uses intro markers generated by your Plex server. No button press needed."
        ),
        "autoSkipIntroIntroDB": SettingDescriptor(
            icon: "cloud",
            iconColor: .cyan,
            description: "Uses IntroDB crowd-sourced episode intro timestamps when available."
        ),
        "autoSkipRecapSettings": SettingDescriptor(
            icon: "gobackward",
            iconColor: .mint,
            description: "Choose whether IntroDB recap markers should be skipped automatically."
        ),
        "autoSkipRecapIntroDB": SettingDescriptor(
            icon: "cloud",
            iconColor: .mint,
            description: "Uses IntroDB crowd-sourced recap timestamps for previously-on segments."
        ),
        "autoSkipCreditsSettings": SettingDescriptor(
            icon: "stop.circle",
            iconColor: .orange,
            description: "Choose which end marker sources can skip credits or outros automatically."
        ),
        "autoSkipCreditsPlex": SettingDescriptor(
            icon: "stop.circle",
            iconColor: .orange,
            description: "Uses credits markers generated by your Plex server, going straight to the post-play screen."
        ),
        "autoSkipCreditsIntroDB": SettingDescriptor(
            icon: "cloud",
            iconColor: .orange,
            description: "Uses IntroDB crowd-sourced outro timestamps as end credits markers."
        ),
    ...
    static func pageInfo(for page: SettingsPage) -> (icon: String, color: Color) {
        ...
        case .autoSkipIntroSettings: return ("play.circle", .green)
        case .autoSkipRecapSettings: return ("gobackward", .mint)
        case .autoSkipCreditsSettings: return ("stop.circle", .orange)
